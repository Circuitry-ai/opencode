...
export const dict = {
  ...
  "enterprise.title": "Company server",
  "enterprise.description": "Sign in with your company account to use managed models and servers.",
  "enterprise.signedInAs": "Signed in as",
  "enterprise.signIn": "Sign in with company server",
  "enterprise.signOut": "Sign out",
  "enterprise.signOut.busy": "Signing out…",
  "enterprise.signOut.confirm.title": "Sign out of company server?",
  "enterprise.signOut.confirm.description": "You will need to sign in again to use managed models and servers.",
  "enterprise.server": "Server",
  "enterprise.login.title": "Company sign in",
  "enterprise.login.description": "Opens your browser to finish single sign-on.",
  "enterprise.login.open": "Continue in browser",
  "enterprise.login.waiting": "Waiting for you to finish signing in…",
  "enterprise.login.reopen": "Open browser again",
  "enterprise.login.success": "Signed in to company server",
